...
cached copies of data, but in some cases, a CMO instruction may operate on the
copy of data in memory. Furthermore, CMO instructions are grouped by operation
